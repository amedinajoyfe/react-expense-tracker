...
exports.MovementsModule = MovementsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([movements_entity_1.Movement])],
        controllers: [movements_controller_1.MovementsController],
        providers: [movements_service_1.MovementsService, movements_repository_1.MovementsRepository],
    })
], MovementsModule);
